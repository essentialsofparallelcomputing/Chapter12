...
int main(int argc, char *argv[]){
   ...
   cl_mem dev_redscratch = clCreateBuffer(context, CL_MEM_READ_WRITE, block_size*sizeof(double), NULL, &iret);
   ...
   if (block_size > 1) {
      iret=clSetKernelArg(kernel_reduce_sum_stage2of2, 0, sizeof(cl_int), (void *)&block_size);
